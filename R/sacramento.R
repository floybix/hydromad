...
#' @param etmult Multiplier applied to \code{DATA$E} to estimate potential evapotranspiration.
#' @param dt Length of each time step in days.
#' @param return_state Not currently supported.
#' @return the simulated effective rainfall (``total channel inflow''), a time series of the same length as the input series.
#' @export
sacramento.sim <-
    function(DATA,
